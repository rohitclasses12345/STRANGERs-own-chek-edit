...
BOT_TOKEN = getenv("BOT_TOKEN", "7636582763:AAHOywcD5yDYP0ZJX7Lp5yfUsjSiPYrBxkU")
...
LOG_GROUP = getenv("LOG_GROUP", "-1003050726636")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1003050726636"))
