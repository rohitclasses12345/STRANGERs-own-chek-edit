...
BOT_TOKEN = getenv("BOT_TOKEN", "8261204625:AAH0RzzD16xO0Ml9JnItFRLbTIqEvzazJAg")
...
LOG_GROUP = getenv("LOG_GROUP", "-1003113700362")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1003113700362"))
